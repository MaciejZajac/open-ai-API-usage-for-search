  ...
  return (
    <div className="p-6 pt-12 xl:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll">
      ...
      {images.length > 0 ? (
        <div className="flex flex-wrap max-sm:justify-center gap-5">
          {images.map((item, index) => (
            ...
            >
              ...
              />
              <p className="absolute bottom-0 right-0 text-xs bg-black/50 backdrop-blue text-white px-4 py-1 rounded-tl-xl opacity-0 group-hover:opacity-100 transition duration-300">
        ...
        <p className="text-center text-gray-600 dark:text-purple-200 mt-100">
          No images
        </p>
      )}
    </div>
