...
const Sidebar = ({
  ...
  return (
    ...
    >
      ...
      {chats.length > 0 ? <p className="mt-4 text-sm">Recent Chats</p> : null}
      ...
      <div className="flex items-center justify-between gap-2 p-3 mt-4 border border-gray-400 dark:border-white/15 rounded-md">
